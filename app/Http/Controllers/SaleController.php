...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Đã tạo sản phẩm gửi đi'
        ]);
    ...
    public function apiSales()
    {
        ...
        return Datatables::of($sales)
            ->addColumn('action', function($sales){
                return'<a onclick="editForm('. $sales->id .')" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> Sửa</a> ' .
                    '<a onclick="deleteData('. $sales->id .')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Xóa</a>';
            })
