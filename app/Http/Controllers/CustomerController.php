...
class CustomerController extends Controller
{
    ...
    public function apiCustomers()
    {
        ...
        return Datatables::of($customer)
            ->addColumn('action', function($customer){
                return '<a onclick="editForm('. $customer->id .')" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> Sửa</a> ' .
                    '<a onclick="deleteData('. $customer->id .')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Xóa</a>';
            })
    ...
    public function ImportExcel(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            return redirect()->back()->with(['success' => 'Đã tải file data khách hàng !']);
        }
