...
class ProductMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Đã tạo sản phẩm mua vào'
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Đã cập nhật sản phẩm mua vào
'
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Đã xóa sản phẩm mua vào'
        ]);
    }
    ...
    public function apiProductsIn(){
        ...
        return Datatables::of($product)
            ...
            ->addColumn('action', function($product){
                return '<a onclick="editForm('. $product->id .')" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> Sửa</a> ' .
                    '<a onclick="deleteData('. $product->id .')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Xóa</a> ';
