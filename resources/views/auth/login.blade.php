                ...
                <div class="auth-box ">
                            ...
                            <form class="form-auth-small" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="alert alert-danger alert-dismissible">
                                        ...
                                        <strong><i class="icon fa fa-ban"></i> Thông báo!</strong> &nbsp; {{ $errors->first('email') }}
                                    </div>
                                    @endif
                                </div>
                                <!-- Log on to codeastro.com for more projects! -->
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" id="signin-password" value="{{ old('password') }}" placeholder="Mật khẩu">
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Hệ thống quản lý hàng tồn kho</h1>
                        </div>
                    </div>
