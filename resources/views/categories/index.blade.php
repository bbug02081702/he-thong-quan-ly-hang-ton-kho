...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-success" ><i class="fa fa-plus"></i> Thêm danh mục mới</a>
            <a href="{{ route('exportPDF.categoriesAll') }}" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Xuất PDF</a>
            <a href="{{ route('exportExcel.categoriesAll') }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Xuất Excel</a>
        </div>
    ...
    <script type="text/javascript">
        ...
        function deleteData(id){
            ...
            swal({
                ...
                text: "Bạn sẽ không thể hoàn nguyên cái này!",
                type: 'cảnh báo',
