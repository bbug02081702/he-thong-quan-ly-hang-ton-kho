...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            <h3 class="box-title">Danh sách sản phẩm mua hàng</h3>


        </div>

        <div class="box-header">
            <a onclick="addForm()" class="btn btn-success" ><i class="fa fa-plus"></i> Thêm mới mua hàng</a>
            <a href="{{ route('exportPDF.productMasukAll') }}" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Xuất PDF</a>
            <a href="{{ route('exportExcel.productMasukAll') }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Xuất Excel</a>
        </div>
        ...
        <div class="box-body">
            <table id="invoice" class="table table-bordered table-hover table-striped">
                ...
                @foreach($invoice_data as $i)
                    ...
                    <td>{{ $i->tanggal }}</td>
                    <td>
                        <a href="{{ route('exportPDF.productMasuk', [ 'id' => $i->id ]) }}" class="btn btn-sm btn-danger">Xuất hóa đơn</a>
                    </td>
                    </tbody>
                @endforeach
            </table>
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function addForm() {
            ...
            $('.modal-title').text('Thêm giao dịch mua mới');
        }
        ...
        function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Chỉnh sửa sản phẩm mua');
